...
3. PLAN.md exists + no new request → EXECUTE mode: for the next pending step, call step_developer agent then step_tester agent. On PASS mark done and continue. On FAIL mark blocked and stop.
